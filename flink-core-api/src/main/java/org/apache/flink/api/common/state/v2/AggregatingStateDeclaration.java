...
public interface AggregatingStateDeclaration<IN, ACC, OUT> extends StateDeclaration {
    /** Get type information of this aggregating state's input. */
    TypeDescriptor<IN> getInTypeInformation();

    /** Get type information of this aggregating state's output. */
    TypeDescriptor<OUT> getOutTypeInformation();
