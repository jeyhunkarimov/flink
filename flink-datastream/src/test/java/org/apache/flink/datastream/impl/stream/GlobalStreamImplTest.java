...
class GlobalStreamImplTest {
    ...
    void testConfig() throws Exception {
        ...
        SlotSharingGroupDescriptor ssg = SlotSharingGroupDescriptor.newBuilder("test-ssg").build();
        ...
        assertThat(transformation.getSlotSharingGroup())
                .hasValue(SlotSharingGroup.fromDescriptor(ssg));
    }
}
